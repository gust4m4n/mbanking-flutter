...
class MbxReceiptScreen extends StatelessWidget {
  final MbxReceiptModel receipt;
  final bool backToHome;
  MbxReceiptScreen({required this.receipt, required this.backToHome});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<MbxReceiptController>(
        init: MbxReceiptController(receipt: receipt, backToHome: backToHome),
            ...
            bodyView: Column(children: [
                          ...
                          : Container(
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image:
                                      AssetImage('lib/images/mbx_sticker.png'),
                                ...
                                child: SingleChildScrollView(
                                    ...
                                    child: Column(children: [
                                      ...
                                      ListView.builder(
                                          ...
                                          physics: ClampingScrollPhysics(),
                                          itemCount:
                                              controller.receipt.details.length,
              ...
              Padding(
                ...
                child: ButtonX(
                  ...
                  title: backToHome ? 'Kembali ke Beranda' : 'Kembali',
                  onClicked: () {
                    controller.btnBackClicked();
                  },
                ),
